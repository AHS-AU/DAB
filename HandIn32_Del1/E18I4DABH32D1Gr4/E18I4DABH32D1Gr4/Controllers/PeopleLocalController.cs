...
{
    public class PeopleLocalController : Controller
    {
        private readonly PersonContext _context;

        public PeopleLocalController(PersonContext context)
        {
            _context = context;
        }
