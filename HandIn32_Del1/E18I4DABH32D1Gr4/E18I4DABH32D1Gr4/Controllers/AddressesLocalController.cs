...
{
    public class AddressesLocalController : Controller
    {
        private readonly PersonContext _context;

        public AddressesLocalController(PersonContext context)
        {
            _context = context;
        }
        ...
        {
            var personContext = _context.Address.Include(a => a.City);
            return View(await personContext.ToListAsync());
        }

        // GET: AddressesLocal/Details/5
