...
{
    public class CitiesLocalController : Controller
    {
        private readonly PersonContext _context;

        public CitiesLocalController(PersonContext context)
        {
            _context = context;
        }
        ...
        // GET: CitiesLocal/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: CitiesLocal/Create
